...
<link rel="stylesheet" type="text/css"
	href="resources/asset/css/plugins/font-awesome.min.css" />
<link rel="stylesheet" type="text/css"
	href="resources/asset/css/plugins/simple-line-icons.css" />
<link rel="stylesheet" type="text/css"
	href="resources/asset/css/plugins/animate.min.css" />
<link rel="stylesheet" type="text/css"
	href="resources/asset/css/plugins/fullcalendar.min.css" />
...
<body id="mimin" class="dashboard">
	...
	<jsp:include page="headerClean2.jsp" />
	<!-- end: Header -->
	...
	<div class="container-fluid mimin-wrapper">
		...
		<!-- start:Left Menu -->
		<div id="left-menu">
			<div class="sub-left-menu scroll" style="padding-top: 0px">
		...
		<div id="content">
			...
			<div class="col-md-12" style="padding: 20px;">
						...
						<div class="col-md-12 padding-0">
							...
							<div class="col-md-6">
								<div class="panel box-v1">
									...
									<div class="panel-body text-center">
										<h1>${adminDetails.totalOrders}</h1>
										<p>Total Orders</p>
										<hr />
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="panel box-v1">
									...
									<div class="panel-body text-center">
										<h1>${adminDetails.totalRequests}</h1>
										<p>Total Request</p>
										<hr />
									</div>
								</div>
						...
						<div class="col-md-12 padding-0">
							<div class="panel box-v3">
								...
								<div class="panel-body">
									...
									<div class="media">
										<div class="media-left">
											<span class="icon-energy icons" style="font-size: 4em;"></span>
										</div>
										<div class="media-body">
											<h5 class="media-heading">Request Processed
												${adminDetails.totalQueuePer}%</h5>
											<div class="progress progress-mini">
												<div class="progress-bar" role="progressbar"
													aria-valuenow="${adminDetails.totalQueuePer}"
													aria-valuemin="0" aria-valuemax="100"
													style="width: ${adminDetails.totalQueuePer}%;">
													<span class="sr-only">${adminDetails.totalQueuePer}%
														Complete</span>
												</div>
											</div>
										</div>
									...
									<div class="media">
										<div class="media-left">
											<span class="icon-pie-chart icons" style="font-size: 4em;"></span>
										</div>
										<div class="media-body">
											<h5 class="media-heading">Orders Completed</h5>
											<div class="progress progress-mini">
												<div class="progress-bar progress-bar-success"
													role="progressbar" aria-valuenow="19" aria-valuemin="0"
													aria-valuemax="100" style="width: 19%;">
								...
								<div class="panel-footer bg-white border-none">
									<center>
										<input type="button" value="Till the time"
				...
				<div class="btn btn-danger box-shadow-none" style="width: 100%" >Request Queue</div>
					<div class="col-md-12">
						<div class="panel">
							<div class="panel-heading bg-white border-none"
								style="padding: 20px;">
								<div class="col-md-12 responsive-table">
									<table class="table table-hover">
										...
										<c:forEach items="${adminDetails.listQueue}" var="result">
										<c:set var="count" value="${count+1}" scope="page"></c:set>
											<tr>
												<td>${count} </td>
												<td>${result.isbn}</td>
												<c:choose>
													<c:when test="${result.isOrdered==1}">
			...
			<div id="right-menu">
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab"
						href="#right-menu-user"> <span class="fa fa-comment-o fa-2x"></span>
					</a></li>
					<li><a data-toggle="tab" href="#right-menu-notif"> <span
							class="fa fa-bell-o fa-2x"></span>
					</a></li>
					<li><a data-toggle="tab" href="#right-menu-config"> <span
							class="fa fa-cog fa-2x"></span>
					</a></li>
				</ul>
				...
				<div class="tab-content">
					<div id="right-menu-user" class="tab-pane fade in active">
						...
						<div class="user col-md-12">
							<ul class="nav nav-list">
								<li class="online"><img
									src="resources/asset/img/avatar.jpg" alt="user name">
									<div class="name">
										<h5>
											<b>Bill Gates</b>
										</h5>
								...
								<li class="away"><img src="resources/asset/img/avatar.jpg"
									alt="user name">
									<div class="name">
										<h5>
											<b>Bill Gates</b>
						...
						<div class="col-md-12 chatbox">
									...
									<div class="msg_container_base">
										<div class="row msg_container send">
											...
											<div class="col-md-3 col-xs-3 avatar">
												<img src="resources/asset/img/avatar.jpg"
							...
							<div class="user-list">
								<ul>
									<li class="online"><a href="" data-toggle="tooltip"
										data-placement="left" title="Akihiko avaron">
											<div class="user-avatar">
												<img src="resources/asset/img/avatar.jpg" alt="user name">
											</div>
											<div class="dot"></div>
									</a></li>
									<li class="offline"><a href="" data-toggle="tooltip"
										data-placement="left" title="Akihiko avaron"> <img
											src="resources/asset/img/avatar.jpg" alt="user name">
											<div class="dot"></div>
									</a></li>
									<li class="away"><a href="" data-toggle="tooltip"
										data-placement="left" title="Akihiko avaron"> <img
											src="resources/asset/img/avatar.jpg" alt="user name">
											<div class="dot"></div>
									</a></li>
					...
					<div id="right-menu-config" class="tab-pane fade">
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="mini-onoffswitch onoffswitch-warning">
									<input type="checkbox" name="onoffswitch2"
										class="onoffswitch-checkbox" id="myonoffswitch7" checked>
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="mini-onoffswitch onoffswitch-danger">
									<input type="checkbox" name="onoffswitch2"
										class="onoffswitch-checkbox" id="myonoffswitch8" checked>
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="mini-onoffswitch onoffswitch-success">
									<input type="checkbox" name="onoffswitch2"
										class="onoffswitch-checkbox" id="myonoffswitch9" checked>
		...
		<div id="mimin-mobile" class="reverse">
			<div class="mimin-mobile-menu-list">
				<div
					class="col-md-12 sub-mimin-mobile-menu-list animated fadeInLeft">
					<ul class="nav nav-list">
		...
		<script type="text/javascript">
			(function(jQuery) {
				...
				window.onload = function() {
					...
					window.myDoughnut2 = new Chart(ctx4).Doughnut(
							doughnutData2, {
								responsive : true,
								showTooltips : true
							});
